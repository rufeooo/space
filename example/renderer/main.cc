...
int main() {
  ...
  if (!gl_shader_cache.CompileShader(
        "vert", renderer::ShaderType::VERTEX, kVertexShader) ||
      !gl_shader_cache.CompileShader(
        "frag", renderer::ShaderType::FRAGMENT, kFragmentShader)) {
